...
<body>
	...
	<div class="container">
		...
		<form:form action="freeRegist.wow" modelAttribute="freeBoard"
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					...
					<td><form:password path="boPass"
							cssClass="form-control input-sm" /> <form:errors path="boPass" />
				...
				<tr>
					...
					<td><%=request.getRemoteAddr()%> <input type="hidden"
						name="boIp" value="<%=request.getRemoteAddr()%>"> <!-- form:form에서도 기존 input=text 쓸 수 있음
			input type=date도 사용 가농, form 태그가 제공 안하는건 기존의 input으로 써도 돼용 --></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><form:textarea path="boContent"
							cssClass="form-control input-sm" row="10" /> <form:errors
							path="boContent" /></td>
				</tr>
				<tr>
					<th>첨부파일
