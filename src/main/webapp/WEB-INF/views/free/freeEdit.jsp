		...
		<form:form action="freeModify.wow" method="post"
			...
			<table class="table table-striped table-bordered">
				...
				<tr>
					<th>비밀번호</th>
					<td>
						<form:password path="boPass" cssClass="form-control input-sm" title="알파벳과 숫자로 4글자 이상"/>						
				...
				<tr>
					<th>분류</th>
					<td>
					<form:select path="boCategory" class="form-control input-sm">
				...
				<tr>
					<th>내용</th>
					<td>
					<form:textarea path="boContent" row="10" cssClass="form-control input-sm"/>
